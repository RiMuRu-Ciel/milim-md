...
`.trim(), msg, {
	...
	async onCall(json) {
		...
		await this.sendMessage(from, 'Maaf, Tolong jangan telfon Milim-Chann', MessageType.extendedText)
...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'Perintah ini hanya dapat digunakan oleh _*@6282173064242*_',
        owner: 'Perintah ini hanya dapat digunakan oleh _*@62821730642*_!',
