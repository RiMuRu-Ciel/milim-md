...
${isSurrender ? '' : `+${room.winScore} XP tiap jawaban benar`}
    `.trim()
        await this.sendButton(m.chat, caption, 'Ｍａｄｅ ｂｙ Ｃｉｅｌ-Ｃｈａｎｎ & Ｒｉｍｕｒｕ-Ｓａｍａ ❤', `${isWin ? 'Family 100' : isSurrender ? 'Family 100' : 'Nyerah'}`, `${isWin ? ',family100' : isSurrender ? ',family100' : 'nyerah'}`, {
            contextInfo: {
