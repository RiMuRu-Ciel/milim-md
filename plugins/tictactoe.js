...
`.trim()
            if (room.x !== room.o) await conn.sendButton(room.x, str, 'Ciel-Chann & Rimuru-Sama', 'Nyerah', 'nyerah', m)
            await conn.sendButton(room.o, str, 'Ciel-Chann & Rimuru-Sama', 'Nyerah', 'nyerah', m)
        } else {
            room = {
